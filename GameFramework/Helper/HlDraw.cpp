...
void HlDraw::RenderTriangleStrip(const MtVector3 *pv3Position, BtU32 numVertex, const RsColour &colour, BtFloat width, BtU32 sortOrder)
{
	RsVertex3 vertex[32 * 3 + 3];
...
{
	MtVector3 v3Pos[8];
	v3Pos[0] = MtVector3(-v3HalfDimension.x, -v3HalfDimension.y, -v3HalfDimension.z );
	v3Pos[1] = MtVector3(-v3HalfDimension.x, -v3HalfDimension.y,  v3HalfDimension.z );
	v3Pos[2] = MtVector3(-v3HalfDimension.x,  v3HalfDimension.y, -v3HalfDimension.z );
	v3Pos[3] = MtVector3(-v3HalfDimension.x,  v3HalfDimension.y,  v3HalfDimension.z );
	v3Pos[4] = MtVector3( v3HalfDimension.x, -v3HalfDimension.y, -v3HalfDimension.z );
	v3Pos[5] = MtVector3( v3HalfDimension.x, -v3HalfDimension.y,  v3HalfDimension.z );
	v3Pos[6] = MtVector3( v3HalfDimension.x,  v3HalfDimension.y, -v3HalfDimension.z );
	v3Pos[7] = MtVector3( v3HalfDimension.x,  v3HalfDimension.y,  v3HalfDimension.z );
	for( BtU32 i=0; i<8; i++ )
	{
		v3Pos[i] *= m4Transform;
	}
